  ...
  function handleChange(e) {
    ...
    if (input.name === "email") {
      ...
      if (input.value.length < 1) {
        ...
        setNameError("Имя может содержать только буквы, пробел и дефис");
      } else {
        setNameError("");
      }
    }
      ...
      <div className='profile__container'>
        ...
        <form className='profile__info' onSubmit={handleSubmit} >
          <div className='profile__name'>
            ...
            {props.isEditState ?
              <input
                className={`profile__input ${!isValidName ? 'profile__input_error' : ''}`}
                type='text'
                name='name'
          ...
          <div className='profile__email'>
            ...
            {props.isEditState ?
              <input className={`profile__input ${!isValidEmail ? 'profile__input_error' : ''}`}
                type='email'
                name='email'
