...
function MoviesCard(props) {
  ...
  function handleDeleteClick() {
    props.mainApi.deleteMovie(props.movie._id)
      .then(() => {
        const savedFilteredMovies = JSON.parse(localStorage.getItem('savedFilteredMovies')).filter((item) => item._id !== props.movie._id);
  ...
  return (
    <li className='movies-card' key={location.pathname === '/movies' ? props.movie.id : props.movie.movieId}>
